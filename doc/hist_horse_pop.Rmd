...
```{r plot horses, fig.width=10, fig.height=3, fig.cap="Figure 1 horses plot", fig.align='center'}
...
max_horses <- horse_pop %>% 
  ...
  summarize(Maximum = max(Value),
            Minimum = min(Value))
knitr::kable(max_horses, caption = "Table 1 max horses table") |>
  kableExtra::kable_styling(full_width = FALSE)
```

Below we zoom in and look at the province of Alberta:

```{r plot province, fig.width=5, fig.height=4, fig.cap="Figure 2 province plot", fig.align='center'}
